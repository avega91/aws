...
class AppController extends Controller {
    ...
    protected $_html;
    public $ext = '.php';
    public $helpers = array('Menu', 'Core', 'Content', 'Utilities', 'ImageSize','Minify.Minify');
    public $components = array(
        ...
        'Auth' => array(
            ...
            //'loginRedirect' => '/',
            //'logoutRedirect' => '/logout', //"/Access/logout",
            //'loginAction' => '/login',
            'authenticate' => array(
                'Form' => array(
...
*/
        ...
        if(!$this->request->is('post') || strtolower($this->action) == 'mobileadd') {
