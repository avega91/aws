 ...
 */
        ...
        'defaults' => 'php',
        'timeout' => 8640, // The session will timeout after 30 minutes of inactivity
        'cookieTimeout' => 8640, // The session cookie will live for at most 24 hours, this does not effect session timeouts
        'checkAgent' => false,
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi4Lb');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453542496749683645RT05');
