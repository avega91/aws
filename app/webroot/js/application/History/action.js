...
function callAddHistory(families, top_covers, tension, widths, importUrl){
    ...
    $('input[name="date_install"]').datepicker($.datepicker.regional[ jsVars.systemLanguage]);
    //$( 'input[name="date_install"]' ).datepicker( "option", "dateFormat", "M d, y" );
    ...
    $('input[name="date_failed"]').datepicker($.datepicker.regional[ jsVars.systemLanguage]);
    ...
    $('#belt_manufacturer').change(function() {
        ...
        if(beltManufacturer<19){
            $('#family_chosen,#compounds_top_cover_chosen').show();
            $('input[name="other_manufacturer"],input[name="other_family"],input[name="other_compound"]').val("");
            $('input[name="other_manufacturer"],input[name="other_family"],input[name="other_compound"]').addClass("hidden");
            ...
            $('#family, #compounds_top_cover').html("").trigger("chosen:updated");
            $('#family_chosen,#compounds_top_cover_chosen').hide();
            $('input[name="other_manufacturer"],input[name="other_family"],input[name="other_compound"]').removeClass("hidden");
        }
