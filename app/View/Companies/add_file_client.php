...
if ($response['success']) {
    ...
    if(count($secure_params)>2){
        $urlSave = $this->Html->url(array('controller' => 'Companies', 'action' => 'saveFileClient', $secure_params[0], $secure_params[1],$secure_params[2], $secure_params[3]));
    }else{
        $urlSave = $this->Html->url(array('controller' => 'Companies', 'action' => 'saveFileClient', $secure_params[0], $secure_params[1]));
    }
?>
    <form id="add_file_conveyor_form" action="<?php echo $urlSave; ?>" class="fancy_form">
        <div class="fancy-content">
            ...
            <div id="file_report">
                ...
                <div id="name_file" class="hidden"></div>
                <div class="space"></div>
            </div>
        </div>
