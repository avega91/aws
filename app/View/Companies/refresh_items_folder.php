 ...
 *
 *     @file refresh_items_folder.php
 *     View layer for action refreshItemsFolder of controller
 *
 *     @project    Contiplus
...
<?php
$secureFolderParams = $this->Utilities->encodeParams($folder['id']);
$secureClientParams = $this->Utilities->encodeParams($folder['client_id']);
$urlAddItemClient = $this->Html->url(array('controller' => 'Companies', 'action' => 'addItemClient', $secureClientParams['item_id'], $secureClientParams['digest'], $secureFolderParams['item_id'], $secureFolderParams['digest']));
$addFileUrl = $this->Html->url(array('controller' => 'Companies', 'action' => 'addFileClient', $secureClientParams['item_id'], $secureClientParams['digest'], $secureFolderParams['item_id'], $secureFolderParams['digest']));
