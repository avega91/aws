    ...
    <body>
        <div id="header">
            <div class="center-aligned">
                <p class="title-datasheet-download"><?php echo __("Metadata Buoy Project", true); ?></p>
            </div>
            <div class="center-aligned">
                <p class="title-conveyor-download"><?php echo $buoySystem['FolderApp']['name']; ?></p>
            </div>
        ...
        <div id="footer">
            <div id="info_conveyor">
                <div>
                    <span>
                    <?php 
                        $fechaActualizacion = $this->Utilities->transformVisualFormatDate($buoySystem['BsMetadata']['created_at'],true);
                        echo __('Ultima modificacion',true); 
                    ?>:
                    </span>
                    <b><?php echo $fechaActualizacion; ?></b></div>
                <div><span><?php echo __('Cliente',true); ?>: </span><b><?php echo $buoySystem['FolderApp']['name']; ?></b></div>
            </div>
            <p class="page"></p>
            <div id="disclaimer">
        ...
        <div id="content">            
            <?php  $this->Content->printDatasheetBuoySystemPreview($buoySystem); ?>
        </div>
    </body>
</html
<?php
...
$dompdf->render();
$dompdf->stream($buoySystem['FolderApp']['name'].".pdf",array('Attachment'=>0));