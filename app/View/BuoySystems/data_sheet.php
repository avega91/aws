 ...
 *     @date      2014
 */ 
$securFolderParams = $this->Utilities->encodeParams($buoySystem['FolderApp']['id']);
$urlDownloadDatasheet = $this->Html->url(array('controller' => 'BuoySystems', 'action' => 'downloadDatasheet', $securFolderParams['item_id'], $securFolderParams['digest']));
...
<div class="full-page">
    <div class="data-page">
        ...
        <div class="data-section">
            <?php
            $this->Content->printDatasheetBuoySystem($buoySystem);
            ?>
        </div>
    </div>