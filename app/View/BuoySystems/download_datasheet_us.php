    ...
    <body>
        <div id="header">
            <div class="center-aligned">
                <p class="title-datasheet-download"><?php echo __("Technical data of conveyor", true); ?></p>
            </div>
            <div class="center-aligned">
            ...
            <div id="info_conveyor">
                <div>
                    <span><?php 
                                ...
                                echo __('Last edited',true);
                                ?>:
                    </span>
                    <b><?php echo $fechaActualizacion; ?></b></div>
                <div><span><?php echo __('Customer',true); ?>: </span><b><?php echo $conveyor['Empresa']['name']; ?></b></div>
                <div><span><?php echo __('Distributor',true); ?>: </span><b><?php echo $conveyor['Distribuidor']['name']; ?></b></div>
            </div>
            <p class="page"></p>
            <div id="disclaimer">
        ...
        <div id="content">            
            <?php  $this->Content->printDatasheetConveyorPreviewUs($conveyor); ?>
        </div>
    </body>
</html
<?php
