...
<html>
	...
	<?php
                ...
                echo $this->Minify->css(array('site.css','menu','core','forms', 'reset'));
            ...
            <div id="direct_menu">
                ...
                <ul id="main_saver">
                    <li class="dropdown_menu main-saver">
                        ...
                        <ul>
                            <span>&nbsp;</span>
                            <li><?php echo $this->Html->link(__('Buoys', true), '#modal', array('class' => 'add_buoys', 'alt' => 'company-dialog|callNewCompany', 'rel' => $this->Html->url(array('controller' => 'Companies', 'action' => 'append')))); ?></li>
                            <li><?php echo $this->Html->link(__('Hoses', true), '#modal', array('class' => 'add_conveyor', 'alt' => 'conveyor-dialog|callAddConveyor|callUpdateConveyorsDataTable', 'rel' => $this->Html->url(array('controller' => 'Conveyors', 'action' => 'add')))); ?></li>
                            <?php /*
                            <?php if($addCompanyColaboratorAllow){ ?>
                                <li><?php echo $this->Html->link(__('Empresa', true), '#modal', array('class' => 'add_user', 'alt' => 'company-dialog|callNewCompany', 'rel' => $this->Html->url(array('controller' => 'Companies', 'action' => 'append')))); ?></li>
                            ...
                            <?php } ?>
                            <?php if($addNotificationsAllow && $credentials['role_company']!=UsuariosEmpresa::IS_CLIENT){
