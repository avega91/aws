...
<html>
 ...
 ga('send', 'pageview');
    ...
    <body>                     
        <?php $responsive_class = $is_mobile ? 'responsive-page movil-page' : ''; ?>
        <?php $desktop_class = $is_mobile ? '' : 'desktop-version'; ?>
        <div id="container" class="responsive-page <?php echo $desktop_class; ?>">    
            <div id="header">                
                <?php echo $this->Html->link('','#',array('id'=>'main_logo')); ?>
                <?php if (!$is_mobile) { $this->Menu->top($just_language = true); } ?>
            </div>
            <!--            <div id="toolbar"></div>-->
            <div id="content">
                <?php 
        ...
        <div id="footer" class="<?php echo $responsive_class; ?>">
