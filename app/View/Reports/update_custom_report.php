 ...
 *
 *     @file update_custom_report.php
 *     View layer for action update_custom_report of controller
 *
 *     @project    Contiplus
 ...
 */
if ($response['success']) {
    $secureItemParams = $this->Utilities->encodeParams($custom_report['CustomReport']['id']);
    $urlEdit = $this->Html->url(array('controller' => 'Reports', 'action' => 'processUpdateCustomReport', $secureItemParams['item_id'], $secureItemParams['digest']));
?>
<input type="hidden" id="selected_conveyors" value="<?php echo $conveyors; ?>"/>
<input type="hidden" id="selected_fields" value="<?php echo $fields; ?>"/>
...
<form id="add_custom_report_form" action="<?php echo $urlEdit; ?>" class="fancy_form">
    <div class='slide-form-section'>        
        <div id="detalle" class="active_section">
            <div id="conveyor_list">
                <h1><?php echo __('Transportadores'); ?><span class="conveyors-selector unselected"></span></h1>
                <div></div>
            </div>
            <div class="space"></div>
            <div class="full-controls">
                    <input type="text" value="<?php echo $custom_report['CustomReport']['title'];?>"placeholder="<?php echo __('Titulo de reporte', true); ?>" name="titulo_reporte" id="titulo_reporte" class="validate[required] main-input"/>
            </div>
            <div class="form-data">                
                <div class="full-controls">
                ...
                <div class="full-controls actions-in-select">
